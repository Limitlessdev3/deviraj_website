                        ...
                        <li class="flag-dropdown-hide">
                            <div class="flag-dropdown">
                                <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                                    aria-expanded="false">
                                    <img src="assets/img/flags/flag-01.png" alt height="20" class="flag-img">
                                    <span>English</span>
                                </a>
                                <div class="dropdown-menu">
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="assets/img/flags/flag-01.png" alt height="16"> English
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="assets/img/flags/flag-02.png" alt height="16"> French
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="assets/img/flags/flag-03.png" alt height="16"> Spanish
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="assets/img/flags/flag-05.png" alt height="16"> German
                                    </a>
                                </div>
                            </div>
                        </li>
...
<h2 class="breadcrumb-title">Get Consultation</h2>
<nav aria-label="breadcrumb" class="page-breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
<li class="breadcrumb-item" aria-current="page">Get Consultation</li>
</ol>
</nav>
</div>
</div>
        ...
        <div class="doctor-content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="back-link">
                            <a href="paitent-details.html"><i class="fa-solid fa-arrow-left-long"></i> Back</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body booking-card-body booking-list-body">
                                <div class="booking-list">
                                    <div class="booking-date-list">
                                        <ul>
                                            <li>Booking Date: <span>Sun, 30 Aug 2022</span></li>
                            ...
                            <div class="card-body booking-card-body">
                                <div class="booking-doctor-details">
                                    <div class="booking-doctor-left">
                                        <div class="booking-doctor-img">
                                            <a href="javascript:void(0);">
                                                <img src="assets/img/patients/patient3.jpg" alt>
                                            </a>
                                        </div>
                                        <div class="booking-doctor-info">
                                            <h4><a href="profile-settings.html">John Smith</a></h4>
                                            <p>P123456</p>
                                        </div>
                                    </div>
                                    <div class="booking-doctor-right">
                                        <p>
                                            <a href="profile-settings.html">Edit</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="booking-doctor-details">
                                    <div class="booking-device">
                                        <div class="booking-device-img">
                                            <img src="assets/img/icons/device-message.svg" alt>
                                        </div>
                                        <div class="booking-doctor-info">
                        ...
                        <div class="card booking-card mb-0">
                            <div class="card-body booking-card-body">
                                <div class="booking-doctor-details">
                                    <div class="booking-device">
                                        <div class="booking-device-img">
                                            <img src="assets/img/icons/smart-phone.svg" alt>
                                        </div>
                                        <div class="booking-doctor-info">
                                            <h3>Get the App</h3>
                                            ...
                                            <div class="app-images">
                                                <a href="javascript:void(0);">
                                                    <img src="assets/img/google-img.svg" alt>
                                                </a>
                                                <a href="javascript:void(0);">
                                                    <img src="assets/img/app-img.svg" alt>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
